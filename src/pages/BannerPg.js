          ...
          <div className="pt-20 grid lg:grid-cols-2">
            {isVietnamese ?
              <div className="my-auto lg:pr-10">
                ...
                <div className="text-center lg:mt-5"><button className='animate__animated animate__fadeInLeft animate__delay-4s orangeBtn mb-5'> Xem thêm về tôi</button></div>
              </div>
              :
              <div className="my-auto lg:pr-10">
                ...
                <div className="text-center lg:mt-5"><button className='animate__animated animate__fadeInUp animate__delay-4s orangeBtn mb-5'>More About Me</button></div>
              </div>
            }
